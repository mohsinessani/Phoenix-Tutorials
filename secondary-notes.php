<?php
 include_once('academy_admin/source/config.php');
    ...
    try 
    {
        ...
        // Make a sql query
        $sql = "SELECT * FROM notes  WHERE category='Higher Secondary' ";
...
<meta name="keywords" content="academy, course, education, education cources, Hardware , software, Networking , Security , learning, PCM,PCMB, Maths, Science, Commerces, Phoenix Tutorials," />
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <ol class="breadcrumb text-center text-black mt-10">
                ...
                <li><a href="javascripts:void(0);">Resources</a></li>
