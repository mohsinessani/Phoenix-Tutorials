...
$output = [];
        ...
        //{
          //  $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            ...
            // Make a sql query
            //$sql = "SELECT * FROM event ORDER BY event_date DESC LIMIT 4";
  ...
  try 
        {
            ...
            if($stmt->execute())
        {
            $output4 = $stmt->fetchAll(PDO::FETCH_ASSOC);
        }
...
//         $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
//         // Make a sql query
//         $sql = "SELECT * FROM popup ORDER BY id DESC LIMIT 1";
...
//         if($stmt->execute())
//         {
//             $outputpop = $stmt->fetchAll(PDO::FETCH_ASSOC);
//         }
//     }
//     catch(PDOException $e)
//     {
...
<meta name="keywords" content="Phoenix Tutorials, course, education, education, elearning, learning, primary, secondary, diploma, English, Maths, Physics, PCMB, PCB, PCM" />
<meta name="author" content="Ajay Gaikar" />

<!-- Page Title -->
<title>Phoenix Tutorials || Home</title>
...
s1.async=true;
s1.src='https://embed.tawk.to/5e306b728e78b86ed8ab7f67/default';
s1.charset='UTF-8';
...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
          ...
          <ul>
            ...
            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg5.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
              ...
              <div class="tp-caption tp-resizeme" 
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-lg btn-flat btn-theme-colored border-left-theme-color-2-6px pl-20 pr-20" href="register-course.php">View Details</a> 
              </div>
            </li>
            ...
            <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg7.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
              ...
              <div class="tp-caption tp-resizeme text-uppercase bg-theme-colored-transparent text-white font-raleway pl-30 pr-30"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:700; border-radius: 30px;">Today's best coaching Tuitions
              </div>
              ...
              <div class="tp-caption tp-resizeme" 
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-default btn-circled btn-transparent pl-20 pr-20" href="#about">Apply Now</a> 
              </div>
            </li>
            ...
            <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg1.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
              ...
              <div class="tp-caption tp-resizeme" 
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-lg btn-flat btn-theme-colored btn-theme-colored border-right-theme-color-2-6px pl-20 pr-20" data-toggle="modal" data-target="#BSParentModal" href="ajax-load/reservation-form.php">Apply Now</a> 
              </div>
          ...
          <div class="row equal-height-inner mt-sm-0" data-margin-top="-150px">
            <div class="col-sm-12 col-md-6 pr-0 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay1">
              <div class="sm-height-auto" data-bg-img="images/about/h1.jpg">
                <div class="p-20">
                  <h3 class="text-white text-uppercase">Get 20% Discount In All Courses</h3>
                  <div class="clearfix">
                  </div>
                  <p class="text-white-f1 mt-10 lead">Phoenix Tutorials therefore offers you a complete package giving a student friendly atmosphere with an affordable fees structure as well.</p>
                  <a href="register-course.php" class="btn btn-default font-14 btn-theme-colored mt-10 hvr-bounce-to-left no-border">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-sm-12 col-md-6 pl-0 pl-sm-15 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay2">
              <div class="sm-height-auto" data-bg-img="images/about/h2.jpg">
                <div class="p-30">
                  <h3 class="text-white text-uppercase">Want to get admission now?</h3>
                  <p class="lead text-white-f1">"A great opportunity for students to choose a world full of knowledge with us."
                  <br>   
                    "So Join Us To Fly High Like A Phoenix Bird"</p>
                  <ul class="pull-left flip hidden-sm hidden-xs">
                    <li>
                      <!-- Modal: Book Now Starts -->
                      <a class="btn btn-default text-theme-colored font-14 bs-modal-ajax-load mt-0 p-10 pr-15" data-toggle="modal" data-target="#BSParentModal" href="ajax-load/reservation-form.php">Get admission Now</a>
                      <!-- Modal: Book Now End -->
                    </li>
                  </ul>
                </div>
            ...
            <div class="owl-carousel-3col owl-nav-top" data-dots="true">
              <div class="item">
                <div class="project mb-30 border-2px">
                  <div class="thumb">
                    <img class="img-fullwidth" alt="computer Hardware" src="images/project/computer-hardware.jpg">
                    <div class="hover-link">
                      <a class="btn btn-flat btn-dark btn-theme-colored btn-md pull-left font-20" href="primary.php"><span>View Course</span> </a>
                    </div>
                  </div>
                  <div class="project-details p-15 pt-10 pb-10" style=" border-bottom: 1px solid rgb(2, 132, 132) !important;">
                    <h5 class="font-14 font-weight-500 mb-5">5<sup>th</sup> to 10<sup>th</sup> All subjects</h5>
                    <h4 class="font-weight-700 text-uppercase mt-0"><a class="text-theme-colored" href="primary.php">Secondary Classes</a></h4>
                    <p>PHOENIX TUTORIAL gives all relevant knowledge  to all our  Secondary Students to achieve excel in their coming prosperous years. All the subjects are covered  such as English,  Science, Algebra, Geometry Hindi, Marathi.</p>
                    <ul class="list-inline project-conditions text-center m-0 p-10">
                      ...
                      <li class="remaining-days"><strong>Duration</strong>12 Months</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="project mb-30 border-2px">
                  <div class="thumb">
                    <img class="img-fullwidth" alt="Networking" src="images/project/network.jpg">
                    <div class="hover-link">
                      <a class="btn btn-flat btn-dark btn-theme-colored btn-md pull-left font-20" href="secondary.php"><span>View Course</span> </a>
                    </div>
                  </div>
                  <div class="project-details p-15 pt-10 pb-10"  style="border-bottom: 1px solid rgb(2, 132, 132) !important;">
                    <h5 class="font-14 font-weight-500 mb-5">11<sup>th</sup> & 12<sup>th</sup> Comm, Sci </h5>
                    <h4 class="font-weight-700 text-uppercase mt-0"><a class="text-theme-colored" href="secondary.php">Higher Secondary Classes</a></h4>
                    <p>PHOENIX TUTORIAL is the  best of Higher Secondary Commerce Section which consists of subjects like (Accounts, Organisations of Commerce, Secretarial Practice, Economics, Maths and English).</p><br>
                    <ul class="list-inline project-conditions text-center m-0 p-10">
                      <!--<li class="current-fund"><strong>Time</strong> June 26</li>-->
                      <li class="target-fund"><strong>Discount</strong>15%</li>
                      <li class="remaining-days"><strong>Duration</strong>12 Months</li>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  <div class="thumb">
                    <img class="img-fullwidth" alt="Security" src="images/project/security.jpg">
                    <div class="hover-link">
                      <a class="btn btn-flat btn-dark btn-theme-colored btn-md pull-left font-20" href="diploma.php"><span>View Course</span> </a>
                    </div>
                  </div>
                  <div class="project-details p-15 pt-10 pb-10" style=" border-bottom: 1px solid rgb(2, 132, 132) !important;">
                    <h5 class="font-14 font-weight-500 mb-5">1<sup>st</sup> Year</h5>
                    <h4 class="font-weight-700 text-uppercase mt-0 "><a class="text-theme-colored" href="diploma.php">Diploma</a></h4>
                    <p>Our class has the  best of Diploma Section which consists of subjects like (Physics,Chemistry,Maths and English,etc) </p><br><br>
                    <ul class="list-inline project-conditions text-center m-0 p-10">
                      <!-- <li class="current-fund"><strong>Time</strong> June 26</li> -->
                      <li class="target-fund"><strong>Discount</strong>15%</li>
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="p-40 pl-0">
              ...
              <form id="reservation_form" name="reservation_form" class="reservation-form" method="post" action="ajax-load/reservation.php"><h3 class="mt-0 line-bottom mb-40">Get A Free<span class="text-theme-color-2"> Registration Now!</span></h3>
                <div class="row">
                  <div class="col-sm-12">
    ...
    <section id="mission">
      <div class="container-fluid pt-0 pb-0">
        ...
        <!--  <div class="col-sm-6 col-md-6 p-0 bg-img-cover wow fadeInRight hidden-xs" data-bg-img="images/photos/mission.jpg" data-wow-duration="1s" data-wow-delay="0.3s">
          </div> -->
    ...
    <!-- Section: Gallery -->
    <section class="divider parallax layer-overlay overlay-dark-8" data-bg-img="images/bg/bg6.jpg" id="gallery">
            ...
            foreach ($output as $row) {
              ...
              <div class="item">
                <div class="work-gallery">
                  <div class="gallery-thumb" style="height: 209px !important;">
                    <img class="img-fullwidth" alt="'.$row['image_title'].'" src="academy_admin/images/gallery/'.$row['image_file'].'">
                    <div class="gallery-overlay"></div>                  
                    <div class="gallery-contect">
                      <ul class="styled-icons icon-bordered icon-circled icon-sm">
                        <li><a href="academy_admin/images/gallery/'.$row['image_file'].'" download><i class="fa fa-link"></i></a></li>
                        <li><a data-rel="prettyPhoto" href="academy_admin/images/gallery/'.$row['image_file'].'"><i class="fa fa-arrows"></i></a></li>
                      </ul>
                    </div> 
                  </div>
                  <div class="gallery-bottom-part text-center">
                    <h4 class="title text-uppercase font-raleway font-weight-600 m-0">'.$row['image_title'].'</h4>
                  </div>
                </div>
              </div>';
            	}
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-5 wow fadeInRight pr-40" data-wow-duration="1s" data-wow-delay="0.3s">
              <h3 class="text-uppercase title line-bottom">What <span class="text-theme-color-2 font-weight-700">Student Say ?</span></h3>
              <div class="bxslider bx-nav-top">
              <?php
               foreach ($output4 as $row) {
              
               echo '
                <div class="testimonial bg-theme-colored border-radius-10px p-20 mb-15">
                  <div class="comment">
                   <p class="text-white"><em>'.$row['feedback'].'</em></p>
                  </div>
                  <div class="content mt-20">
                    <div class="thumb pull-left flip">
                      <img width="64" src="academy_admin/images/stud-feedback/'.$row['student_photo'] .'" alt="' . $row['name'] . '" class="img-circle">
                    </div>
                    <div class="testimonials-details pull-left flip ml-20">
                      <h5 class="author text-theme-color-2 mt-0 mb-0 font-weight-600">'.$row['name'].'</h5>
                      <h6 class="title font-14 m-0 mt-5 mb-5 text-gray-darkgray">'.$row['department'].'.</h6>
            ...
            //<div class="col-xs-12 col-sm-6 col-md-6 mb-30 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              //<div class="pricing table-horizontal maxwidth400">
                //<div class="row">
                  ...
                  //<div class="col-md-6">
                    //<div class="thumb">
                    //<img class="img-fullwidth mb-sm-0" src="academy_admin/images/events/'.$row1['event_image'].'" alt="'.$row1['event_title'].'">
                    //</div>
                  //</div>
                  //<div class="col-md-6 p-30 pl-sm-50">
                    //<h4 class="mt-0 mb-5"><a href="#" class="text-white">'.$row1['event_title'].'</a></h4>
                    ...
                    //</ul>
                    //<p class="mb-15 mt-15 text-white myevent">'.$row1['event_description'].'.</p>
                    //<a class="text-white font-weight-600" href="event.php?id='.$row1['id'].'">Read More →</a>
                  //</div>
                //</div>
              //</div>
            //</div>';
    ...
    <!--        <a href="#promoModal1" data-lightbox="inline" class="btn btn-default">Trigger Modal</a>-->
            ...
            <!-- popup modal -->
    <!--        <a href="form-appointment.php">-->

    <!--        <div id="promoModal1" class="modal-promo-box mfp-hide" >-->
    <!--      <?php
        //   foreach ($outputpop as $row ) {
             
        //   echo'-->
        //     <img src="images/popup/'.$row['pop_image'].'">
             
        //      <a href="#" class="button" onClick="$.magnificPopup.close(); return false;"">'.$row['pop_title'].'</a>';
        //   }
             ?>-->
    <!--        </div></a>-->
  ...
  <!-- end main-content -->
  <div style="position: fixed;left: 0px; bottom: 238px;">
     <a class="btn btn-default text-theme-colored font-14 bs-modal-ajax-load mt-0 p-10 pr-15" data-toggle="modal" data-target="#BSParentModal" href="ajax-load/reservation-form.html">I<br>N<br>Q<br>U<br>I<br>R<br>Y</a>
  </div>
  <div id="mySidenav" class="sidenav" style="position: fixed;left: 0px; bottom: 238px;">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  

</div>
<a class="text-theme-colored font-14 bs-modal-ajax-load mt-0 p-10 pr-15" data-toggle="modal" data-target="#BSParentModal" href="ajax-load/reservation-form.php"><span style="font-size:30px;cursor:pointer;color:red;position:fixed; top:238px; left: 0px;" onclick="openNav()">&#9776;</span></a>
