    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            <div class="x_panel">
                <form id="galleryForm" action="source/gallery_form.php" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" placeholder="Tilte of the image " type="text" name="image_title" />
                        </div>
                    </div>
