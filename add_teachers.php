    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            <div class="x_panel">
                <form id="teachersForm" action="source/teachers_form.php" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                   <!--  <?php 
                        // if(isset($_GET['id']))
                        // {
                        //     $id = $_GET['id'];
                    ...
                    <div class="well">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" placeholder="Teacher Designation"  class="form-control" name="designation"  >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" min="0" class="form-control"  name="whatsapp" placeholder="1234567890" > 
                            </div>
                        </div>
