                        ...
                        <?php
                          ...
                          foreach ($output as $row) {
                            ...
                            echo '<tr>
                                    ...
                                    <td><img class="img-thumbs" src="images/gallery/'.$row['image_file'].'"></td>
                                    <td>'.$title.'</td>
                                    <td>'.$description .'</td>
                                    <td>'.$row['category'].'</td>
                                    <td>'.$date->format('Y-m-d H:i').'</td>
                                    <td>
                                      <a href="gallery_update.php?id='.$row['id'].'" title="Update"><span class="glyphicon glyphicon-pencil"></span></a>
                                      <a href="source/gallery_delete.php?id='.$row['id'].'" onclick = "return confirm(\'Do you really want to Delete?\')" title="delete"><span class="glyphicon glyphicon-trash"></span></a>
                                    </td>
                                  </tr>
                                  ';
                            $countt++;
