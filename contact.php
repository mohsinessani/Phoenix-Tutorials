                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <?php
                          ...
                          echo' <tr>
                                  ...
                                  <!--<td>
                                    <a href="source/delete_contact.php?id='.$row['id'].'" onclick = "return confirm(\'Do you really want to Delete?\')" title="delete"><span class="glyphicon glyphicon-trash"></span></a>
                                  </td>-->
                                </tr>';
                                $countt++;
                    }
