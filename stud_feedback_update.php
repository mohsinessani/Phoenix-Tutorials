...
include_once('source/config.php');
    ...
    $post_dir       = '../academy_admin/images/stud-feedback/';
if (isset($_GET['id'])) 
{
    include_once('source/config.php');
    $id = $_GET['id'];
...
<html lang="en">
  <head>
    ...
    <title>Phoenix Tutorials Student feddBack Update || Dashboard</title>
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            <div class="x_panel">
                <form id="galleryForm" action="source/feedback_form_update.php" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                    <?php 
                        if(isset($_GET['id']))
                        {
                            $id = $_GET['id'];
                    ...
                    <div class="well">
                        <label class="tab-head">Feedback Details</label>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Student name <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" placeholder="Name of student"  class="form-control" name="name" value="<?=$name?>"  >
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" placeholder="Enter tagline"  class="form-control" name="department" value="<?=$department?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea class="form-control" rows="4" name="feedback"><?=$feedback?> </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Select Image<span class="required">*</span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            <div style="background-size:cover; background-repeat:no-repeat; background-image:url('images/stud-feedback/<?=$student_photo?>')">
