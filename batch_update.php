  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            <div class="x_panel">
                <form id="galleryForm" action="source/batch_form_update.php" method="POST" class="form-horizontal form-label-left">
                <?php 
                        if(isset($_GET['id']))
                        {
                            $id = $_GET['id'];
                   ...
                   <div class="form-group">
                              ...
                              <div class="controls">
                                <div class="input-prepend input-group">
                                  <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                   <input type="text" placeholder="dd month, year" class="form-control datepicker" name="start_date" value="<?=$start_date?>" >
                                </div>
                              </div>
                            </div>
                        </div> 
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="control-group">
                              <div class="controls">
                                <div class="input-prepend input-group">
                                  <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                   <input type="text" placeholder="dd month, year" class="form-control datepicker" name="end_date"  value="<?=$end_date?>">
                                </div>
                              </div>
                            </div>
                        </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" placeholder="Enter durationof cource " type="text" name="duration" value="<?=$duration?>"/>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" placeholder="Enter batch time " type="text" name="day_time" value="<?=$day_time?>"/>
                        </div>
                    </div>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" placeholder="Enter batch  " type="text" name="days" value="<?=$days?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" placeholder="Enter address of classroom" type="text" name="location" value="<?=$location?>"/>
                        </div>
                    </div> -->
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        $("select option[value='<?=$batch?>']").attr('selected', 'selected');
          var options = { 
