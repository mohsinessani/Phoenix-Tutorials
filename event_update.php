...
include_once('source/config.php');
    ...
    $event_dir       = '../academy_admin/../images/events/';
if (isset($_GET['id'])) 
{
    include_once('source/config.php');
    $id = $_GET['id'];
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            <div class="x_panel">
                <form id="galleryForm" action="source/event_form_update.php" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                    <?php 
                        if(isset($_GET['id']))
                        {
                            $id = $_GET['id'];
                    ...
                    <div class="well">
                        <label class="tab-head">Event Details</label>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Event Tilte <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" placeholder="Title of the Event"  class="form-control" name="event_title" value="<?=$event_title?>"  >
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Event Location <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" placeholder="Location of the Event"  class="form-control" name="event_location" value="<?=$event_location?>" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Event Description <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea class="form-control" rows="4" name="event_description"><?=$event_description?> </textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Select Image<span class="required">*</span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            <div style="background-size:cover; background-repeat:no-repeat; background-image:url('images/events/<?=$event_image?>')">
