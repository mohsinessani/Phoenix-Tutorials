    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            <div class="x_panel">
                <form id="galleryForm" action="source/popup_form.php" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name"> Pop-up Title <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" placeholder="Tilte of the image " type="text" name="pop_title" />
                        </div>
                    </div>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea class="form-control" rows="4" name="image_description"> </textarea>
                        </div>
                    </div> -->
                    <div class="form-group">
                        <div class="col-md-12">
    ...
    <script type="text/javascript">
      ...
      function showResponse(responseText, statusText, xhr, $form)  { 
            ...
            if(classTemp == "success")
            {
                // redirect
                setTimeout(function(){
                    window.location.replace("popup.php");
                }, 1500);
            }
