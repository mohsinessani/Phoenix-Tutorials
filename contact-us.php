...
function processRating(val, attrVal){
    $.ajax({
        ...
        success : function(data) {
            if (data.status == 'ok') {
                alert('Thank You...\n You have rated '+val+'star to Phoenix Tutorials');
...
<div id="wrapper" class="clearfix">
      ...
      <div class="container">
        <div class="row pt-30">
          <div class="col-md-8">
            ...
            <!-- Contact Form -->
            	<form id="contact_form" name="contact_form" class="form-transparent" action="contact-form.php" method="post">
              <div class="row">
                <div class="col-sm-6">
              ...
              <div class="col-xs-12 col-sm-6 col-md-12 text-white">
                <div class="icon-box left media bg-black-333 p-25 mb-20"> <a class="media-left pull-left" href="#"> <i class="pe-7s-mail text-theme-color-2"></i></a>
                  <div class="media-body"> <strong class="text-white">OUR CONTACT E-MAIL</strong>
                    <p> <a class="text-white" href="mailto:helpphoenix2008@gmail.com">helpphoenix2008@gmail.com</a></p>
                  </div>
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-12 text-white">
 ...
 <!--  <div class="container">
        <div class="row">
          <div class="col-md-12">
   -->          <div class="modal fade zoomInUp" id="myModal" data-backdrop="static" data-keyboard="false">
              <div class="modal-dialog modal-sm" style="margin-top: 23% !important;">
              <div class="modal-content">
                    <div class="modal-header" style="border-bottom: 1px solid #000;">
                      <a class="close" data-dismiss="modal" style="color:red">X</a>
                      <center style="color:#000;"><strong>RATING</strong></center>
                    </div>
                    <div class="modal-body" >
                      <center><input name="rating" value="0" id="rating_star" type="hidden" postID="1" /></center>
                        <div class="overall-rating" style="color:#000; font-weight:bold">(Average Rating <span id="avgrat"><?php echo $ratingRow['average_rating']; ?></span>
