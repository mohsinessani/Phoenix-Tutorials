<?php
  include_once("academy_admin/config.php");
   $id = $_GET['id'];
  $sql1="SELECT * FROM  event where id=$id";
...
<meta name="author" content="Naimah" />

<!-- Page Title -->
<title>Phoenix Tutorials Academy</title>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <h3 class="font-28 text-white"><?=$row1['event_title']?></h2>
          ...
          <div class="col-md-12">
            ...
            <!--<script type="text/javascript">
              $(document).ready(function() {
                $('#basic-coupon-clock').countdown('2017/02/28', function(event) {
    ...
    <section>
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8">
            <img src="academy_admin/images/events/<?=$row1['event_image']?> " alt="">
          </div>
        </div>
        <div class="row mt-60">
          <div class="col-md-6">
            <h4 class="mt-0">Event Description</h4>
            <p><?=$row1['event_description']?></p>
          </div>
          <div class="col-md-6">
            <blockquote>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            <form id="booking-form" name="booking-form" action="http://kodesolution.com/demo/wxyz/w/learnpress/v2.0/demo/includes/event-register.php" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-sm-12">
