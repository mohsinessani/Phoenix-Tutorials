      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Popup Image</small></h2>
                    <ul class="nav navbar-right">
                        <a href="popup_add.php" class="btn btn-primary "><i class="fa fa-plus"> New POP-UP Image</i></a>
                    </ul>
                        ...
                        <?php
                          ...
                          foreach ($output as $row) {
                            ...
                            echo '<tr>
                                    ...
                                    <td><img class="img-thumbs" src="../images/popup/'.$row['pop_image'].'"></td>
                                    <td>'.$row['pop_title'].'</td>
                                    <td>'.$row['created'].'</td>
                                    <td>
                                      <a href="popup_update.php?id='.$row['id'].'" title="Update"><span class="glyphicon glyphicon-pencil"></span></a>
                                      <a href="source/popup_delete.php?id='.$row['id'].'" onclick = "return confirm(\'Do you really want to Delete?\')" title="delete"><span class="glyphicon glyphicon-trash"></span></a>
                                    </td>
                                  </tr>
                                  ';
                            $countt++;
              ...
              <!-- <a class="btn btn-app notification" >
                ...
                <i class="fa fa-bullhorn"></i>Images
              </a> -->
        </div>
        <!-- /page content -->
