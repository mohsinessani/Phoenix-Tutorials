    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            <div class="x_panel">
                <form id="galleryForm" action="source/event_form.php" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                   <!--  <?php 
                        // if(isset($_GET['id']))
                        // {
                        //     $id = $_GET['id'];
                    ...
                    <div class="well">
                        <label class="tab-head">Event Details</label>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" placeholder="Title of the Event"  class="form-control" name="event_title"  >
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" placeholder="Location of the Event"  class="form-control" name="event_location"  >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea class="form-control" rows="4" name="event_description"> </textarea>
                            </div>
                        </div>
                        <div class="form-group">
